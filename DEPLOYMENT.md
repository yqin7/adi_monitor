...
服务没有登录页，8080 不对公网开放；本机通过 SSH 隧道访问，固定用 **18080**，避免和本机开发的 8080 冲突：

```bash
ssh -N -L 18080:localhost:8080 admin@47.253.220.188
```

然后打开 http://localhost:18080/ui/ （本机开发仍是 http://localhost:8080/ui/）。不用时 Ctrl+C 关闭隧道。
